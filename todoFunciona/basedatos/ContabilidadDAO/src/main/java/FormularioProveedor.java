...
public class FormularioProveedor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cif = jTextField6.getText();
        
        try {
            int telInt = Gestor.getInstance().toInt(tel);
            Proveedor p = new Proveedor(empresa, nombre, cif, address, telInt, email);
            try {
                Gestor.getInstance().addProveedor(p);
