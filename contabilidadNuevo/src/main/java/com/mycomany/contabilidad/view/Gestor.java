...
public class Gestor {
    ...
    public void addCliente(String subcomercial, String nombreContacto, String id, String address, String telephone, String email) throws AppException {
    ...
    public void addClienteEmpresa(String subcomercial, String nombreContacto, String id, String address, String telephone, String email, String nombreEmpresa) throws AppException {
        if (!clientes.containsKey(id)) {
    ...
    public void addProveedor(String nombreEmpresa, String nombreContacto, String id, String address, String telephone, String email) throws AppException {
