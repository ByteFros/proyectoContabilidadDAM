...
public class Interprete {
    ...
    public String askString(String message) {
        ...
        do {
            try {
                string = br.readLine().toUpperCase();
                if ("".equals(string)) {
    ...
    public boolean revisarCliente(String dni, ArrayList<Cliente> clientes) {
        return getCliente(dni, clientes) != null;
    }
    
    public Cliente getCliente(String dni, ArrayList<Cliente> clientes) {
